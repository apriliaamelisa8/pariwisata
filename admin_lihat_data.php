...
<head>
    ...
    <link rel="stylesheet" href="css/style_admin_lihat_data.css?v6">
...
<body >
   <nav class="Navigator">
    ...
    <h1>Daftar Data Destinasi</h1>
        <table >
            <tr>
                <th>Destinas</th>
                <th>Harga</th>
                <th>Include</th>
                <th>Syarat & Kententuan</th>
                <th>Gambar</th>
                <th>Aksi</th>
            </tr>
            ...
            <tr>
                ...
                <br>
                <br>
                <a href="hapus.php?id=<?=$row['id'];?>" onclick="return hapus()">
